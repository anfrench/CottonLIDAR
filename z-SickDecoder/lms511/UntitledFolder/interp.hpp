...
double *interp_lagrange ( int m, int data_num, double t_data[], double p_data[], int interp_num, double t_interp[] );
double *interp_linear ( int m, int data_num, double t_data[], double p_data[], int interp_num, double t_interp[] );
double *interp_nearest ( int m, int data_num, double t_data[], double p_data[], int interp_num, double t_interp[] );
double *lagrange_value ( int data_num, double t_data[], int interp_num, double t_interp[] );
...
void r8vec_bracket0 ( int n, double x[], double xval, int &left,int &right );
